...
@section('title', __('Merchant Login'))
    ...
    <div class="auth-page d-flex align-items-center justify-content-center">
        <div class="login-card rounded shadow p-4">
            <div class="text-center mb-4">
                ...
                <h4 class="fw-bold">{{ __('Merchant Login') }}</h4>
                <p class="text-muted mb-0">
                    {{ __('Sign in to your merchant account with') }} {{ setting('site_title') }}
                </p>
                <div class="mt-2 mb-3">
                    <span class="badge bg-success p-2">
                        <i class="fa-duotone fa-store me-1"></i> {{ __('Merchant Account') }}
                    </span>
                </div>
            </div>
            ...
            <form action="{{ route('merchant.login') }}" method="post">
                ...
                {{-- Login Button --}}
                <button class="btn btn-success w-100 sm-mb-text" type="submit">
            ...
            <p class="text-center mt-4 mb-0 sm-mb-text">
                {{ __("Don't have a merchant account?") }}
