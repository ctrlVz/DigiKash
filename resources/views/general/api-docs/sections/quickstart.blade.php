<section id="quick-start" class="content-section">
	...
	<p>@lang('Get up and running with DigiKash API in just a few steps'):</p>
	...
	<div class="row mb-4">
		<div class="col-md-6">
			<div class="card border-0 shadow-sm">
				...
				<div class="card-body">
					<ol>
						<li>@lang('Login to your DigiKash dashboard')</li>
	...
	<div class="text-center">
		...
		<p class="text-muted mt-2">@lang('Try DigiKash API endpoints directly in your browser')</p>
	</div>
