<section id="authentication" class="content-section">
	...
	<p>@lang('DigiKash API uses API keys to authenticate requests. You can obtain your credentials from your merchant dashboard.')</p>
	...
	<div class="alert alert-info mb-4">
		<div class="d-flex align-items-center">
			...
			<div>
				...
				<p class="mb-0">@lang('DigiKash API supports both sandbox (testing) and production environments. Always test in sandbox first before going live.')</p>
			</div>
		</div>
	</div>
