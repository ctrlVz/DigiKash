...
@section('title', 'DigiKash API Documentation')
@section('description', 'Complete API documentation for DigiKash payment gateway integration with code examples for multiple platforms')
@section('content')
